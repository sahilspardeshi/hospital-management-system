...
const AdminNav = () => {
  return (
    ...
    <div className="container mx-auto flex justify-between items-center">
      ...
      {/* Menu Items */}
      <div className="hidden lg:flex lg:items-center  w-6/12 lg:space-x-10 m-auto" id="menu">
        ...
        <div className="relative group">
          ...
          <ul className="absolute hidden group-hover:block bg-white shadow-md mt-2 rounded">
            <li>
              <a href="#service1" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 no-underline w-40  font-bold">Section 1</a>
            </li>
            <li>
              <a href="#service2" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 no-underline font-bold">Section 2</a>
            </li>
            <li>
              <a href="#service3" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 no-underline font-bold">Section 3</a>
            </li>
            <li>
              <a href="#service3" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 no-underline font-bold">Section 4</a>
            </li>
          </ul>
        </div>
        <div className="relative group">
