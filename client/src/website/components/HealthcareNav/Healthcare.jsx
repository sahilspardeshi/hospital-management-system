...
const HealthCareSection = () => {
  return (
    <div className=" h-auto w-11/12 flex flex-col justify-center font-poppins py-16">
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-screen-2xl mx-auto lg:px-8 pt-0 pb-16">
        ...
        <div className="w-full lg:text-left pr-5">
          <div className="font-bold text-5xl md:text-6xl lg:text-7xl mb-6">
            <h1 className=" font-bold text-3xl lg:text-5xl  mb-6">
             <span className="text-green-600 font-bold text-3xl lg:text-5xl pb-6">We care</span> <br/>
      ...
      <div className="mt-10 p-5 relative flex justify-center items-center  bg-red-100 rounded-full">
        <div className=" p-5 relative flex justify-center items-center  bg-red-50 rounded-full">
      <div className=" lg:w-72  w-52 p-auto relative flex justify-center items-center bg-red-200 rounded-full">
  <img
    src={Dr} //Main Dr Img 
    alt="Doctors"
    className="lg:w-72 lg:h-72 h-52 w-52"
  />
   <div className="absolute lg:top-10 lg:-left-40 -left-20 -top-10 bg-white p-2 rounded-2xl shadow-lg flex items-center lg:space-x-2">
              <span >🔍</span>
              <div>
            ...
            <div className="absolute lg:bottom-10 lg:-left-40 -left-20 -bottom-10 bg-white px-6 p-2 rounded-2xl shadow-lg flex items-center space-x-2">
            ...
            <div className="absolute lg:bottom-6 lg:-right-16 -right-20 bottom-2  bg-white  p-2 rounded-2xl shadow-lg flex items-center space-x-2">
