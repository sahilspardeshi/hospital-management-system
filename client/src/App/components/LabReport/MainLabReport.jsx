...
const dummyReports = [
  {
    id: '1',
    patient_id: 'KSFL18001',
    doctor_id: 'LOAI5001',
    test_name: 'W349588YTH1',
...
export default function MainLabReport() {
  ...
  const handleAddNewFile = () => {
    ...
    navigate(`${hostname}/lab-reports`)
  }

  const handleEditReport = (patient_id) => {
    const hostname = window.location.pathname;
    console.log(hostname)
    navigate(`${hostname}/lab-report-result/${patient_id}`)
  }
  ...
  return (
    ...
    <div className='p-8'>
      <div className="bg-[#E4D7D7] flex justify-between items-center w-full mx-auto py-2 px-4">
        <h1 className="text-xl font-bold">Main Lab Report</h1>
