...
export default function MainvitalSign() {
    return (
        <>

            <div className="flex flex-col   h-[100vh] w-full mt-16  ">
                <div className="w-full max-w-5xl mx-auto ">
                    <h2 className="text-xl font-bold my-4 bg-[#D9D9D9] px-5 py-2 ">Mainvital Signs</h2>
                    <form className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block  text-lg font-bold text-gray-700">List Count</label>
                                <select
                                    name="roomNo"
                                    className="mt-1 p-2 border rounded w-full"
                                >
