...
export default function MedicationList() {
  ...
  return (
    <div>
      <div className=" bg-rose-100 flex justify-between items-center  max-w-5xl mx-auto">
    ...
    <div className="bg-white opacity-70 p-6 rounded-lg shadow-md max-w-5xl mx-auto">
