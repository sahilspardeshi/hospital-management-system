...
<div className="w-9/10 flex justify-between items-center p-4">
          ...
          <ul className="flex justify-center items-center space-x-4">
            <li className="pl-5 pr-5 p-3 hover:bg-green-500 cursor-pointer rounded-full bg-gray-200 text-sm">
              OPD
            </li>
            <li className="pl-5 pr-5 p-3 hover:bg-green-500 cursor-pointer rounded-full bg-green-300 text-sm">
              IPD
            </li>
          </ul>
        </div>
