...
import Navbar from '../StaffPage/Navbar'
import Sidebar from '../StaffPage/Sidebar'
...
export default function IPD() {
    return (
        ...
        <Navbar/>
        <Sidebar />
            <div className='bg-green-100 flex justify-center align-middle'>
                <form className='m-auto  w-[70vw] pl-28 pt-20 '>
